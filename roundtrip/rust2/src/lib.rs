...
#[no_mangle]
pub unsafe extern "C" fn hello_from_rust_2()
{
    println!( "hello from rust2, my friends" );
}

static STATIC_THING: u64 = 1;

#[no_mangle]
pub unsafe extern "C" fn alloc_struct_2() -> Box<Struct>
{
...
#[no_mangle]
pub extern "C" fn free_struct_2(_: Option<Box<Struct>>)
{
